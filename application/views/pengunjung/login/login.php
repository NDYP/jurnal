...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="<?= base_url('assets/') ?>vendor/fonts/Linearicons-Free-v1.0.0/icon-font.min.css">
    <!--===============================================================================================-->
                ...
                <form class="login100-form validate-form flex-sb flex-w">
                    ...
                    <div>
                        <span class="txt1 p-b-11">
                            Username <?= form_error('nip_nim', '<small class="text-danger pl-1">', '</small>'); ?>
                        </span>
                        <div class="wrap-input100 validate-input m-b-36" data-validate="Username is required">
                            <input class="input100" type="text" name="nip_nim">
                            <span class="focus-input100"></span>
                        </div>
                    </div>
                    <div>
                        <span class="txt1 p-b-11">
                            Password <?= form_error('password', '<small class="text-danger pl-1">', '</small>'); ?>
                        </span>
