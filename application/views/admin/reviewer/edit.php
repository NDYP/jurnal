...
<div class="content-wrapper">
    ...
    <section class="content-header">
        <a class="" href="<?= base_url('admin/reviewer'); ?>"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
    ...
    <section class="content">
        ...
        <div class="row">
            ...
            <div class="col-md-8">
                <?= form_open_multipart('admin/reviewer/ubah') ?>
                <div class="box">
                    <div class="box-header bg-navy">
                    ...
                    <div class="box-body">
                        <div class="col-md-6">
                            <input type="hidden" value="<?= $reviewer['id_user']; ?>" name="id_user">
                            <div class="form-group">
                                <label>NIP</label>
                                <input type="text" class="form-control" name="nip_nim" id="nip_nim" value="<?= $reviewer['nip_nim']; ?>">
                                <?= form_error('nip_nim', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>Nama</label>
                                <input type="text" class="form-control" name="nama" value="<?= $reviewer['nama']; ?>">
                                <?= form_error('nama', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>Tempat Lahir</label>
                                <input type="text" class="form-control" name="tempat_lahir" value="<?= $reviewer['tempat_lahir']; ?>">
                                <?= form_error('tempat_lahir', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>Tanggal Lahir</label>
                                <input type="text" class="form-control" id="datepicker" name="tgl_lahir" value="<?= $reviewer['tgl_lahir']; ?>">
                                <?= form_error('tgl_lahir', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <div class="form-group">
                                <label>Alamat</label>
                                <input type="text" class="form-control" name="alamat" value="<?= $reviewer['alamat']; ?>">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>No.Hp</label>
                                <input type="text" class="form-control" name="no_hp" value="<?= $reviewer['no_hp']; ?>">
                                <?= form_error('no_hp', '<small class="text-danger pl-1">', '</small>'); ?>
                            </div>
                            <!-- /.form-group -->
                            <div class="form-group">
                                <label>Email</label>
                                <input type="text" class="form-control" name="email" value="<?= $reviewer['email']; ?>">
                            ...
                            <div class="form-group">
                                ...
                                <select name="id_agama" class="form-control select2" style="width: 100%;">
                                    <?php foreach ($agama as $row) : ?>
                                        <?php if ($reviewer['id_agama'] == $row['id_agama']) : ?>
                            ...
                            <div class="form-group">
                                <div class="checkbox">
                                    ...
                                    <?php foreach ($jk as $row) : ?>
                                        <?php if ($reviewer['id_jk'] == $row['id_jk']) : ?>
                                            <label>
